...
/**
 * Extrai o bloco PEM (-----BEGIN...-----END-----) de qualquer texto ao redor.
 * Isso torna a configuração tolerante a erros comuns de copiar/colar:
 * aspas sobrando do JSON, vírgula no final, o nome do campo junto, etc.
 * Também converte "\n" literal (escapado) em quebra de linha real.
 */
